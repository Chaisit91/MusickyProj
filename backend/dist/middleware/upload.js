...
exports.uploadAd = exports.uploadSong = exports.upload = void 0;
...
const songFileFilter = (_req, file, cb) => {
...
const adFileFilter = (_req, file, cb) => {
    const allowed = [
...
exports.uploadAd = (0, multer_1.default)({
    storage,
