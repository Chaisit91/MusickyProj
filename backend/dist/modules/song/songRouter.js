...
const SongService = __importStar(require("./songService"));
...
router.put("/:id", authMiddleware_1.authMiddleware, (0, roleMiddleware_1.roleMiddleware)("ADMIN"), (0, asyncHandler_1.asyncHandler)(SongService.updateSong));
router.delete("/:id", authMiddleware_1.authMiddleware, (0, roleMiddleware_1.roleMiddleware)("ADMIN"), (0, asyncHandler_1.asyncHandler)(SongService.deleteSong));
