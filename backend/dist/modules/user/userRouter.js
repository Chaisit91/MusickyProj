...
router.put("/:id/unban", ...admin, (0, asyncHandler_1.asyncHandler)(UserService.unbanUser));
router.delete("/:id", ...admin, (0, asyncHandler_1.asyncHandler)(UserService.deleteUser));
